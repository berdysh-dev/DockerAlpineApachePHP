...
RUN cd /usr/local/src ; tar xzf event-3.0.8.tgz ; tar xzf grpc-1.56.0.tgz ; tar xzf igbinary-3.2.14.tgz ; tar xzf memcache-8.2.tgz ; \
...
tar xzf yaml-2.2.3.tgz ; tar xzf zstd-0.12.3.tgz
...
--with-openssl --with-curl --with-zlib --with-bz2
